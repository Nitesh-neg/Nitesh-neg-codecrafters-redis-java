...
//     public static int offset = 0;// for calculating the number of bytes recevied by replica 
//     public static int replicaReadyForCommands=0;
//     private static List<OutputStream> replicaConnections = new ArrayList<>();// all replica connections
...
//                     int availableBytes=pin.available();
...
public class Main {
    ...
    public static int replicaReadyForCommands = 0;
    public static List<OutputStream> replicaConnections = new ArrayList<>();
